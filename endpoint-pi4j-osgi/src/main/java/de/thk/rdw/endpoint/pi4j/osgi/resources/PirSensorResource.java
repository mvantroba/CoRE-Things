...
public class PirSensorResource extends SensorPi4jResource {
	...
	public PirSensorResource(String name, SensorType sensorType, GpioController gpioController, Pin signalPin) {
	...
	@Override
	public void init() {
		signal = gpioController.provisionDigitalInputPin(signalPin, signalPinName, PinPullResistance.PULL_UP);
